...
class Music(commands.Cog):
    ...
    async def play(self, ctx, *, query: str):
        ...
        # ── Fix 4017: send explicit leave first, then rejoin ─────────────
        async def safe_connect(channel):
            # Tell Discord we're leaving any current voice session
        ...
        if not vc:
            ...
            try:
                ...
                try:
                    ...
                    return await searching_msg.edit(embed=error_embed(f"couldn't move: `{e}`"))
